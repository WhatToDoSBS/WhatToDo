...
// }
    ...
    fetch(`/mypage/like/webtoon`)
        ...
        data.forEach(function (item) {
            webtoonNmLikeList.push(item.nm);
        })
        console.log("webtoonNmLikeList : " + webtoonNmLikeList);
    }).catch(e => {
        console.log(e);
    })
...
`;
    ...
    const getWtCmtList = (selectedWebtoonNm) => {
