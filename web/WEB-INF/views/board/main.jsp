...
<div class="main_box">
    ...
    <div class="btn-group-vertical" role="group" aria-label="Basic example" id="guide-tooltip">
        ...
        <button type="button" class="btn btn-outline-info" data-bs-trigger="hover focus" data-bs-toggle="popover" title="슬라이드(Swiper)"
        ...
        <button type="button" class="btn btn-outline-info" data-bs-trigger="hover focus" data-bs-toggle="popover" title="RANK"
        ...
        <button type="button" class="btn btn-outline-info" data-bs-trigger="hover focus" data-bs-toggle="popover" title="YOUTUBE"
    ...
    <div class="project_info_section">
        ...
        <div class="collapse" id="collapseExample" >
            <div class="card card-body">
                ...
                <h4>기술 스택.</h4>
                <p>
                    <span class="color-red">✓ JavaScript</span> : AJax 통신 - fetch API / Rest API / Swiper Library<br><br>
                    <span class="color-red">✓ Java</span> : Spring FrameWork(Rest API, Mybatis, HikariCP, lombok, Gson, BCrypt, tiles) / JSTL / Jsoup<br><br>
