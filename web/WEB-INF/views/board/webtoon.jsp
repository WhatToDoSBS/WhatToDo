...
<div class="btn-group-vertical" role="group" aria-label="Basic example" id="guide-tooltip">
    ...
    <button type="button" class="btn btn-outline-info" data-bs-trigger="focus" data-bs-toggle="popover" title="랜덤 웹툰" data-bs-content="RESTful api 방식. 사용자가 고르고 싶은 주제를 선택하면 JavaScript에서 분기를 처리해 배경과 글씨 색을 바꾸고 선택한 장르에 맞는 랜덤한 데이터를 출력함.">랜덤웹툰</button>
    <button type="button" class="btn btn-outline-info" data-bs-trigger="focus" data-bs-toggle="popover" title="웹툰 정보&리뷰&좋아요"
